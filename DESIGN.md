...
- **Project imagery:** homepage imagery remains a compact preview on the project action. The archive uses layered images; detail pages retain the dark olive surface and expandable gallery. Source links respect the existing source-availability data. Metrics describe documented capability, including 7.5× evidence capacity, three validation indicators, CMS publishing, and three user journeys; they do not imply user counts or investment performance.
