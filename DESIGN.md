...
description: The established visual system and its project showcase exception.
colors:
  ink: "#11120f"
  ink-raised: "#191a16"
  paper: "#f2f0e8"
...
- Do preserve the AK geometry, established palette and type outside the scoped showcase exception.
...
Each study includes a large preview and three selectable image thumbnails: identity/system overview, workflow, and an implementation detail. The full-screen native dialog supports previous/next buttons, arrow keys, Escape, focus return, and scroll locking. SVGs are explicitly labeled system illustrations; only supplied project facts appear in them. Showcase columns fade and progressively blur at the left boundary after scrolling, with inset alignment keeping settled titles readable.
